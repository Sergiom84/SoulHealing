        ...
        <Link href="/exercise2">
          <Card className="rounded-2xl shadow-md border cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">He dado a todo lo que veo el significado que tiene para mí.</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/exercise3">
          <Card className="rounded-2xl shadow-md border cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">No entiendo nada de lo que veo en esta habitación.</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/exercise4">
          <Card className="rounded-2xl shadow-md border cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">Estos pensamientos no significan nada.</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/exercise5">
          <Card className="rounded-2xl shadow-md border cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">Nunca estoy disgustado por la razón que creo.</p>
            </CardContent>
          </Card>
        </Link>
      </div>
