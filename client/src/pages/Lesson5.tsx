            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
              ...
              <TabsContent value="introduccion" className="space-y-6">
                <div className="prose prose-sm dark:prose-invert max-w-none">
                  ...
                  <p>No estoy enfadado con _____ por la razón que creo.</p>
                  <p>No tengo miedo de ____ por la razón que creo.</p>
                  ...
                  <p><b>No hay disgustos pequeños. Todos perturban mi paz mental por igual.</b></p>
                  ...
                  <p><b>No puedo conservar esta forma de disgusto y al mismo tiempo desprenderme de las demás. Para los efectos de estos ejercicios, pues, las consideraré a todas como si fuesen iguales.</b></p>
                  ...
                  <p>No estoy preocupado acerca de ____ por la razón que creo.</p>
                  <p>No estoy deprimido acerca de ____ por la razón que creo.</p>
                  <br />
